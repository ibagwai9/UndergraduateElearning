        ...
        <footer class="footer-area p_120">
            <div class="container">
                <div class="row">
                        ...
                        <div class="single-footer-widget tp_widgets">
                           <h6 class="footer_title">Top Products</h6>
                            <ul class="list">
                            	...
                            	<li><a href="#">College Fortal</a></li>
                            	<li><a href="#">Support and Guide</a></li>
                            	<li><a href="#">Developer Student Club Founder, SRCOE 2020.</a></li>
                            	<li><a href="#">Developer Student Club Lead, ICA, SRCOE 2020.</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2  col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-2  col-md-6 col-sm-6">
                        <div class="single-footer-widget tp_widgets">
                           <h6 class="footer_title">Profession</h6>
                            <ul class="list">
                            	<li><a href="#">Educational softweres</a></li>
